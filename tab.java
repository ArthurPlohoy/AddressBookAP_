...
private final ButtonGroup buttonGroup_2 = new ButtonGroup();
	...
	public tab() {
		...
		JLabel lblCostumerNo = new JLabel("ID");
		...
		JLabel lblAdmissionFees = new JLabel("Department:");
		...
		JLabel lblEnterRegistrationNo = new JLabel("ID");
		...
		JLabel lblRegistrationNo = new JLabel("ID");
		...
		JLabel lblAdmissionNo = new JLabel("Department");
